...
CREATE TABLE `grupos_usuario` (
  ...
  CONSTRAINT `grupos_usuario_ibfk_1` FOREIGN KEY (`id_grupo`) REFERENCES `grupo` (`id`),
  CONSTRAINT `grupos_usuario_ibfk_2` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`)
...
INSERT INTO `grupos_usuario` VALUES (3,2),(3,3),(4,3),(5,4),(5,5);
...
-- Dump completed on 2025-12-04 18:20:46
