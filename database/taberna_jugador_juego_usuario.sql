...
CREATE TABLE `juego_usuario` (
  ...
  CONSTRAINT `juego_usuario_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  CONSTRAINT `juego_usuario_ibfk_2` FOREIGN KEY (`id_juego`) REFERENCES `juego` (`id`)
...
INSERT INTO `juego_usuario` VALUES (2,1),(3,1);
