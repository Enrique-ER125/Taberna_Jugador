...
CREATE TABLE `hechizo` (
  ...
  CONSTRAINT `hechizo_ibfk_1` FOREIGN KEY (`id_estadistica`) REFERENCES `estaditicas` (`id`),
  CONSTRAINT `hechizo_ibfk_2` FOREIGN KEY (`id_juego`) REFERENCES `juego` (`id`)
...
INSERT INTO `hechizo` VALUES (1,'Bola de fuego','Bola de fuego','distancia','fuego',NULL,NULL),(4,'Tifon de fuego','string','cercania','fuego',NULL,NULL);
